...
import { useReactTable, flexRender, getCoreRowModel, ColumnDef, SortingState, getSortedRowModel, getFilteredRowModel, FilterFn } from "@tanstack/react-table"
...
//   interface FilterFns {
//     fuzzy: FilterFn<object>
//   }
// }

export default function DataTable<Data extends object>({ data, columns }: Props<Data>) {
